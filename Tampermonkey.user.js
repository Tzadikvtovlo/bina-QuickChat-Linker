// ==UserScript==
// @name         כפתורי צאט, העתקה, ושמירה להמשך בפורום בינה.טופ
// @namespace    http://tampermonkey.net/
// @version      3.2
// @description  הזרקת לחצן צ'אט מהיר ליד כל פוסט בפורום בינה.טופ והדבקת קישור הפוסט אוטומטית, הזרקת כפתורי העתקת קישור וקריאה בהמשך, והוספת רשימת קריאה בסרגל הצד, כולל תמיכה בקישורי נושאים.
